        ...
        <el-container>
            <el-header>
                <div>
                    <el-row :gutter="30">
                        <el-col :span="7">
                            <el-input placeholder="客户名称" v-model="queryParams.customerName" @clear="query" clearable
                                size="large">
                                <template #append>
                                    <el-button type="info" @click="query" style="color:black">查询</el-button>
                                </template>
            ...
            <el-main>
                <div>
                    ...
                    <el-table :data="preferenceList" style="width: 100% ;color:black;" stripe>
                        <el-table-column align="center" type="id" prop="id" label="序号" width="60" />
          ...
          -->
            ...
            layout=" prev, pager, next" :total="page.total" @current-change="handleCurrentChange" /> -->
                    ...
                    <el-pagination :page-size="page.pageSize" background :current-page="page.curPage"
                        :page-sizes="[2, 3, 4, 5, 6, 10]" layout="total, sizes, prev, pager, next, jumper"
...
import { getListPage, getCustomerList } from "@/api/customerApi.js";
...
// 查询护理项目(分页)
const getPreferenceListData = async () => {
    let res = await findPreference(queryParams)
    console.log("-----" + res)
...
![image-20251228165101689](../image/image-20251228165101689.png)
...
![image-20251228172940301](../image/image-20251228172940301.png)